...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="category-card flex flex-col items-center text-center cursor-pointer" data-aos="fade-up" data-aos-duration="1500" data-aos-anchor-placement="top-bottom">
